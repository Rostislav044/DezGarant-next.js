...
//         <h1>Фумигация</h1>
//         <p>Здесь можно добавить информацию о Фумигация и услугах, которые вы предлагаете.</p>
//       </section>
//       <Footer/>
//       </>
//     );
...
const translations = {
  ua: {
    title: "Послуги з фумігації",
    description:
      "Забезпечте безпеку та здоров'я вашого простору за допомогою наших професійних послуг з фумігації. Ми використовуємо передові методи для боротьби з шкідниками та забезпечення безпечного середовища.",
    services: [
  ...
  ru: {
    title: "Услуги по фумигации",
    description:
      "Обеспечьте безопасность и здоровье вашего пространства с помощью наших профессиональных услуг по фумигации. Мы используем передовые методы для борьбы с вредителями и обеспечения безопасной среды.",
    services: [
...
export default function FumigatsiyaPage() {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="Санитарная служба DezGarant - Фумигация" />
      </Head>
      <Header />
      <section className={styles.infoSection}>
