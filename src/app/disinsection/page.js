...
const translations = {
  ua: {
    ...
    services: [
      { name: "Знищення тарганів —", description: "успішно вирішуємо проблему навіть у найскладніших умовах." },
  ...
  ru: {
    ...
    services: [
      { name: "Уничтожение тараканов —", description: "успешно решаем проблему даже в самых сложных условиях." },
