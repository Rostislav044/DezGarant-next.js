...
import { pagesPrice } from "../metadata/pagesPrice"; 
...
const translations = {
  ua: {
    ...
    services: [
      { name: "від 1000 грн", description: "Ціна на обробку залежить від м2 та вибраної хімії." },
  ...
  ru: {
    ...
    services: [
      { name: "От 1000 грн.", description: "Цена на обработку зависит от м2 и выбранной химии." },
...
export default function FumigatsiyaPage() {
  ...
  useEffect(() => {
    document.title = pagesPrice.title;
  }, [currentLanguage]);
